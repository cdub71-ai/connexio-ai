...
describe("ClaudeApiService", () => {
  ...
  describe("parseMarketingCommand()", () => {
    ...
    test("should parse marketing command successfully", async () => {
      ...
      const result = await claudeService.parseMarketingCommand(
        mockCommand,
        mockContext,
      );
    ...
    test("should handle API errors gracefully", async () => {
      ...
      await expect(
        claudeService.parseMarketingCommand(mockCommand, mockContext),
  ...
  describe("Intent inference", () => {
    test("should infer email campaign intent", () => {
      expect(claudeService._inferIntent("create email newsletter")).toBe(
        "create_email_campaign",
      );
      expect(claudeService._inferIntent("send email to customers")).toBe(
        "create_email_campaign",
      );
    });

    test("should infer SMS campaign intent", () => {
      expect(claudeService._inferIntent("send sms to users")).toBe(
        "create_sms_campaign",
      );
      expect(claudeService._inferIntent("text message campaign")).toBe(
        "create_sms_campaign",
      );
    });

    test("should infer status check intent", () => {
      expect(claudeService._inferIntent("check campaign status")).toBe(
        "get_campaign_status",
      );
      expect(claudeService._inferIntent("show me campaign progress")).toBe(
        "get_campaign_status",
      );
    });
  ...
  describe("Edge cases and error scenarios", () => {
    test("should handle empty Claude response", async () => {
      ...
      await expect(
        claudeService.parseMarketingCommand("test", {}),
