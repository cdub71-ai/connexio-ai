...
describe('SureshotApiClient', () => {
  ...
  describe('Authentication', () => {
    ...
    test('should handle authentication failure', async () => {
      ...
      await expect(sureshotClient.authenticate())
  ...
  describe('Request execution', () => {
    ...
    test('should execute request successfully', async () => {
      ...
      const result = await sureshotClient.makeRequest('POST', '/api/v2/campaigns', { name: 'Test' });
    ...
    test('should not retry client errors (400-499)', async () => {
      ...
      await expect(sureshotClient.makeRequest('POST', '/api/v2/test', { invalid: 'data' }))
  ...
  describe('Email campaign operations', () => {
    ...
    test('should execute campaign immediately', async () => {
      ...
      const result = await sureshotClient.executeCampaignImmediate('campaign123');
    ...
    test('should schedule campaign', async () => {
      ...
      const result = await sureshotClient.scheduleCampaign('campaign123', scheduledTime);
  ...
  describe('Contact list operations', () => {
    ...
    test('should sync contact list', async () => {
      ...
      const result = await sureshotClient.syncContactList('list123', syncOptions);
  ...
  describe('Error handling and enhancement', () => {
    ...
    test('should enhance validation errors', () => {
      ...
      validationError.response = { status: 400, data: { errors: ['Invalid email'] } };
  ...
  describe('Advanced campaign features', () => {
    ...
    test('should setup triggered campaign', async () => {
      ...
      const result = await sureshotClient.setupTriggeredCampaign('campaign123', triggers);
    ...
    test('should update campaign settings', async () => {
      ...
      const result = await sureshotClient.updateCampaignSettings('campaign123', settings);
    ...
    test('should get campaign execution history', async () => {
      ...
      const result = await sureshotClient.getCampaignExecutionHistory('campaign123');
