...
describe('ClaudeTaskWorker', () => {
  ...
  describe('parseMarketingCommand()', () => {
    ...
    test('should process marketing command successfully', async () => {
      ...
      mockClaudeService.parseMarketingCommand.mockResolvedValue(mockClaudeResult);
    ...
    test('should track active tasks count correctly', async () => {
      ...
      const tasks = [
        claudeTaskWorker.parseMarketingCommand(mockSlackCommand, 'user1', 'channel1'),
        claudeTaskWorker.parseMarketingCommand(mockSlackCommand, 'user2', 'channel2'),
        claudeTaskWorker.parseMarketingCommand(mockSlackCommand, 'user3', 'channel3')
      ];
    ...
    test('should calculate average processing time correctly', async () => {
      ...
      await claudeTaskWorker.parseMarketingCommand(mockSlackCommand, mockUserId, mockChannelId);
      await claudeTaskWorker.parseMarketingCommand(mockSlackCommand, mockUserId, mockChannelId);
  ...
  describe('Input validation', () => {
    test('should validate Slack command object structure', () => {
      ...
      expect(() => {
        claudeTaskWorker._validateInput(invalidCommand, 'user123', 'channel456');
    ...
    test('should handle minimal valid Slack command', () => {
      ...
      const result = claudeTaskWorker._validateInput(minimalCommand, 'user123', 'channel456');
    ...
    test('should validate user ID format', () => {
      expect(() => {
        claudeTaskWorker._validateInput({ text: 'help' }, 'invalid user id', 'channel456');
      }).toThrow('Invalid user ID format');
    });

    test('should validate channel ID format', () => {
      expect(() => {
        claudeTaskWorker._validateInput({ text: 'help' }, 'user123', 'invalid channel id');
  ...
  describe('Result enhancement', () => {
    test('should enhance result with task metadata', () => {
      ...
      const enhanced = claudeTaskWorker._enhanceResult(claudeResult, validatedInput, context);
  ...
  describe('Error response creation', () => {
    test('should create structured error response', () => {
      ...
      const errorResponse = claudeTaskWorker._createErrorResponse(error, context);
